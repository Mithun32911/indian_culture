...
const ContentCreatorLogin = () => {
  ...
  useEffect(() => {
    ...
    if (urlParams.get('redirect') === 'protected-content') {
      setRedirectMessage('Please login to access Content Creator features.');
    }
  }, [location]);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginTop: '1rem' }}>
            ...
            <div style={{ marginTop: 8 }}>
              <a href="#" onClick={() => navigate('/admin/content-creator-signup')}>Don't have an account? Sign Up</a>
              {' | '}
